            ...
            featured: [
                {
                    name: 'New Arrivals',
                    href: '#',
                    imageSrc: '/product-images/cap.png',
                    imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
                },
                {
                    name: 'Basic Tees',
                    href: '#',
                    imageSrc: '/product-images/hoodie.png',
            ...
            featured: [
                {
                    ...
                    href: '#',
                    imageSrc:
                        '/product-images/oversize-1.png',
                    imageAlt: 'Drawstring top with elastic loop closure and textured interior padding.',
                },
                {
                    name: 'Artwork Tees',
                    href: '#',
                    imageSrc: '/product-images/t-shirt.png',
                    imageAlt:
                    ...
                    <div className="border-b border-gray-200">
                        <div className="flex h-16 items-center">
                            ...
                            <div className="ml-4 flex lg:ml-0">
                                <a href="/">
                                    <span className="sr-only">Shark Tale</span>
                                    <img
                                        alt=""
                                        src="/icons/icon.png"
